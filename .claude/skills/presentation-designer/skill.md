...
| presentation-architect | `.claude/agents/presentation-architect.md` | 데이터 시각화, 정보 계층 설계 | general-purpose |
...
| 2 | 정보 설계 | presentation-architect | 작업 1 | `_workspace/02_info_design.md` |
...
**팀원 간 소통 흐름:**
- storyteller 완료 → presentation-architect에게 데이터 시각화 필요 슬라이드 전달, visual-designer에게 톤앤무드 전달, coach에게 전환 포인트 전달
- presentation-architect 완료 → visual-designer에게 차트 스타일·색상 코드 전달, coach에게 수치 설명 포인트 전달
...
| "이 자료로 슬라이드 만들어줘" (기존 내용) | **슬라이드 모드** | presentation-architect + visual-designer + reviewer |
...
- 슬라이드 모드: presentation-architect + visual-designer + reviewer 투입
...
| `presentation-dataviz-guide` | presentation-architect | 차트 선택 매트릭스, 정보 계층(LATCH), 색상 접근성 |
